...
Data = np.load('HighPartialObsHighDim.npz')

np.random.seed(1)

# simulation parameters

N = 50 # dimension of full system
nLag = 1 # lag of non-Markovian model
nSteps = 50 # simulation time steps
rdim = 40 # dimension of reduced observed state
po = 95 # percentage of observed states
...
# plot
IC = 18 # index for initial condition
